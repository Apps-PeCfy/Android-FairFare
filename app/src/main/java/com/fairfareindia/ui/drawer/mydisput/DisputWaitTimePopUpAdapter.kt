...
class DisputWaitTimePopUpAdapter (
    var endRidesActivity: Activity,
    var arrWaitTime: List<DisputDetailResponsePOJO.WaitingsItem1>
): RecyclerView.Adapter<DisputWaitTimePopUpAdapter.MyViewHolder>() {
