...
class MyComplaintsAdapter(
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.tvDisputNo!!.text =  context?.resources?.getString(R.string.str_id) + " : "+complaintList[position].disputeNo
        ...
        holder.tvFilledDate!!.text = context?.resources?.getString(R.string.str_filed_date) + " : "+str
