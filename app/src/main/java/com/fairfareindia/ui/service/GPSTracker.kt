...
class GPSTracker @RequiresApi(api = Build.VERSION_CODES.M) constructor(private val mContext: Context) :
    ...
    fun showSettingsAlert() {
        ...
        alertDialog.setTitle(mContext.resources.getString(R.string.dialog_gps_title))
        // Setting Dialog Message
        alertDialog.setMessage(mContext.resources.getString(R.string.dialog_gps_message))
        // On pressing Settings button
        alertDialog.setPositiveButton(mContext.resources.getString(R.string.str_settings)) { dialog, which ->
            val intent =
                Intent(Settings.ACTION_LOCATION_SOURCE_SETTINGS)
            mContext.startActivity(intent)
        }
        // on pressing cancel button
        alertDialog.setNegativeButton(mContext.resources.getString(R.string.btn_cancel)) { dialog, which -> dialog.cancel() }
