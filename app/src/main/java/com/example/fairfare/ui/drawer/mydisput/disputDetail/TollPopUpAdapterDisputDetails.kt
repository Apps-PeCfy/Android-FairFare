...
class TollPopUpAdapterDisputDetails (
    var arrWaitTime: List<DisputDetailResponsePOJO.TollsItem>
) : RecyclerView.Adapter<TollPopUpAdapterDisputDetails.MyViewHolder>() {
