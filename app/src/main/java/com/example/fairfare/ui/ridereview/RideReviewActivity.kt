package com.example.fairfare.ui.ridereview
...
@JvmField
    ...
    fun reView(){
        ...
        ApiClient.client.setRideReview("Bearer $token", rideID,
            ratingBar!!.getRating().toString(),editReview!!.text.toString())!!.enqueue(object :
            ...
            override fun onResponse(
                ...
                if (response.code() == 200) {
                    ...
                    try {
                        ...
                        Toast.makeText(this@RideReviewActivity, pojo.message, Toast.LENGTH_LONG).show()
